...
/**
 * Factory Method Pattern - ParkingFloor arayüzünü implement eder.
 * Decorator Pattern     - ParkingService.getService() üzerinden decorated servis kullanır.
 * Singleton Pattern     - Session.getInstance() ile oturum erişimi.
 */
public class Kat1 extends JFrame implements ParkingFloor {
    ...
    private void sagTik(int index) {
        ...
        if (rezerveMi[index]) {
            ...
            String rezervasyonPlaka =
                    ParkingService.getReservationPlate("KAT1", slot);
    ...
    private void parkEt(int index) {
        ...
        parkingService.aracGiris("KAT1", plaka, slot);
    ...
    private void parklariYukle() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(f))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String[] d = line.split(";");
                if (!d[1].equals("KAT1") || !d[4].equals("AKTIF")) continue;
    ...
    private void rezervasyonlariYukle() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(f))) {
            ...
            while ((line = br.readLine()) != null) {
            	...
            	if (!r[1].equals("KAT1") || !r[5].equals("AKTIF")) continue;
    ...
    private int slotIndex(String slot) {
        ...
        return (harf - 'A') * 10 + (no - 1);
    }


    private void cikisYap(int index) {

        // Decorator Pattern - decorated servis üzerinden çıkış
